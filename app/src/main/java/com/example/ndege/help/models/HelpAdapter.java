...
public class HelpAdapter extends RecyclerView.Adapter<HelpAdapter.MyViewHolder>{
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (helpList.get(position).getFile_image()!=null){
            if (URLUtil.isValidUrl("https://storage.googleapis.com/ndege_app/"+helpList.get(position).getFile_image())){
                Picasso.with(context)
                        .load("https://storage.googleapis.com/ndege_app/"+helpList.get(position).getFile_image())
