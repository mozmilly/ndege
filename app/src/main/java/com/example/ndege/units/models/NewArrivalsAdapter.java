...
public class NewArrivalsAdapter extends RecyclerView.Adapter<NewArrivalsAdapter.MyViewHolder> {
    ...
    //declare interface
    private OnNewArrivalItemClicked onClick;

    public interface OnNewArrivalItemClicked {
        void onNewArrivalClicked(int position);
    }
    public NewArrivalsAdapter(List<MenuItems> menuItemsList, Context context) {
...
//        }
    ...
    public void setOnClick(OnNewArrivalItemClicked onClick)
    {
