...
public class MainCategoryAdapter extends RecyclerView.Adapter<MainCategoryAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (mainCategoryList.get(position).getImage()!=null){
            if (URLUtil.isValidUrl("https://storage.googleapis.com/ndege/"+mainCategoryList.get(position).getImage())){
                Picasso.with(context)
                        .load("https://storage.googleapis.com/ndege/"+mainCategoryList.get(position).getImage())
