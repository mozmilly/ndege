...
public class DiscountedItemsAdapter extends RecyclerView.Adapter<DiscountedItemsAdapter.MyViewHolder> {
    List<MenuItems> menuItemsList;
    Context context;


    //declare interface
    private OnDealItemClicked onClick;

    public interface OnDealItemClicked {
        void onDealItemClick(int position);
    }
    public DiscountedItemsAdapter(List<MenuItems> menuItemsList, Context context) {
...
//        }
        ...
        double percentage = Math.round(difference*100/menuItemsList.get(i).getWas_price());
        myViewHolder.percentage_off.setText((percentage+"% off"));
        myViewHolder.parent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onClick.onDealItemClick(i);
            }
        });
    }
    ...
    public void setOnClick(OnDealItemClicked onClick)
    {
